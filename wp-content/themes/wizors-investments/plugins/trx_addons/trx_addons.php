...
if (!function_exists('wizors_investments_trx_addons_theme_setup9')) {
	...
	function wizors_investments_trx_addons_theme_setup9() {
		if (wizors_investments_exists_trx_addons()) {
			...
			add_filter( 'trx_addons_filter_meta_box_fields',			'wizors_investments_trx_addons_meta_box_fields', 10, 2);
			...
			if (is_admin()) {
				add_filter( 'wizors_investments_filter_allow_meta_box', 			'wizors_investments_trx_addons_allow_meta_box', 10, 2);
...
if ( !function_exists( 'wizors_investments_trx_addons_tgmpa_required_plugins' ) ) {
	//Handler of the add_filter('wizors_investments_filter_tgmpa_required_plugins',	'wizors_investments_trx_addons_tgmpa_required_plugins');
...
if ( !function_exists( 'wizors_investments_trx_addons_frontend_scripts' ) ) {
	//Handler of the add_action( 'wp_enqueue_scripts', 'wizors_investments_trx_addons_frontend_scripts', 1100 );
	function wizors_investments_trx_addons_frontend_scripts() {
		if (wizors_investments_exists_trx_addons()) {
			if (wizors_investments_is_on(wizors_investments_get_theme_option('debug_mode')) && wizors_investments_get_file_dir('plugins/trx_addons/trx_addons.css')!='') {
				wp_enqueue_style( 'wizors_investments-trx_addons',  wizors_investments_get_file_url('plugins/trx_addons/trx_addons.css'), array(), null );
				wp_enqueue_style( 'wizors_investments-trx_addons_editor',  wizors_investments_get_file_url('plugins/trx_addons/trx_addons.editor.css'), array(), null );
			}
			if (wizors_investments_is_on(wizors_investments_get_theme_option('debug_mode')) && wizors_investments_get_file_dir('plugins/trx_addons/trx_addons.js')!='')
				wp_enqueue_script( 'wizors_investments-trx_addons', wizors_investments_get_file_url('plugins/trx_addons/trx_addons.js'), array('jquery'), null, true );
		} else {
			...
			if ( wizors_investments_is_on(wizors_investments_get_theme_option('debug_mode')) ) {
				wp_enqueue_style( 'wizors_investments-layouts', wizors_investments_get_file_url('plugins/trx_addons/layouts/layouts.css') );
				wp_enqueue_style( 'wizors_investments-layouts', wizors_investments_get_file_url('plugins/trx_addons/layouts/logo.css') );
				wp_enqueue_style( 'wizors_investments-layouts', wizors_investments_get_file_url('plugins/trx_addons/layouts/menu.css') );
				wp_enqueue_style( 'wizors_investments-layouts', wizors_investments_get_file_url('plugins/trx_addons/layouts/search.css') );
				wp_enqueue_style( 'wizors_investments-layouts', wizors_investments_get_file_url('plugins/trx_addons/layouts/title.css') );
				wp_enqueue_style( 'wizors_investments-layouts', wizors_investments_get_file_url('plugins/trx_addons/layouts/featured.css') );
			}
		}
	}
}
...
if ( !function_exists( 'wizors_investments_trx_addons_merge_styles' ) ) {
	//Handler of the add_filter( 'wizors_investments_filter_merge_styles', 'wizors_investments_trx_addons_merge_styles');
...
if ( !function_exists( 'wizors_investments_trx_addons_merge_scripts' ) ) {
	//Handler of the add_filter('wizors_investments_filter_merge_scripts', 'wizors_investments_trx_addons_merge_scripts');
...
if ( !function_exists( 'wizors_investments_trx_addons_detect_blog_mode' ) ) {
	//Handler of the add_filter( 'wizors_investments_filter_detect_blog_mode', 'wizors_investments_trx_addons_detect_blog_mode' );
...
if ( !function_exists( 'wizors_investments_trx_addons_list_post_types' ) ) {
	//Handler of the add_filter( 'wizors_investments_filter_list_posts_types', 'wizors_investments_trx_addons_list_post_types');
...
if ( !function_exists( 'wizors_investments_trx_addons_post_type_taxonomy' ) ) {
	//Handler of the add_filter( 'wizors_investments_filter_post_type_taxonomy',	'wizors_investments_trx_addons_post_type_taxonomy', 10, 2 );
...
if ( !function_exists( 'wizors_investments_trx_addons_get_post_categories' ) ) {
	//Handler of the add_filter( 'wizors_investments_filter_get_post_categories', 		'wizors_investments_trx_addons_get_post_categories');
...
if ( !function_exists( 'wizors_investments_trx_addons_list_header_styles' ) ) {
	//Handler of the add_filter( 'wizors_investments_filter_list_header_styles', 'wizors_investments_trx_addons_list_header_styles');
...
if ( !function_exists( 'wizors_investments_trx_addons_list_footer_styles' ) ) {
	//Handler of the add_filter( 'wizors_investments_filter_list_footer_styles', 'wizors_investments_trx_addons_list_footer_styles');
...
if ( !function_exists( 'wizors_investments_trx_addons_get_post_date_wrap' ) ) {
	//Handler of the add_filter( 'trx_addons_filter_get_post_date', 'wizors_investments_trx_addons_get_post_date_wrap');
...
if ( !function_exists( 'wizors_investments_trx_addons_get_post_date' ) ) {
	//Handler of the add_filter( 'wizors_investments_filter_get_post_date', 'wizors_investments_trx_addons_get_post_date');
...
if (!function_exists('wizors_investments_trx_addons_allow_meta_box')) {
	//Handler of the add_filter( 'wizors_investments_filter_allow_meta_box', 'wizors_investments_trx_addons_allow_meta_box', 10, 2);
	function wizors_investments_trx_addons_allow_meta_box($allow, $post_type) {
		return $allow
...
if (!function_exists('wizors_investments_trx_addons_allow_theme_icons')) {
	//Handler of the add_filter( 'wizors_investments_filter_allow_theme_icons', 'wizors_investments_trx_addons_allow_theme_icons', 10, 2);
...
if (!function_exists('wizors_investments_trx_addons_meta_box_fields')) {
	//Handler of the add_filter( 'trx_addons_filter_meta_box_fields', 'wizors_investments_trx_addons_meta_box_fields', 10, 2);
	function wizors_investments_trx_addons_meta_box_fields($mb, $post_type) {
		if (defined('TRX_ADDONS_CPT_TEAM_PT') && $post_type==TRX_ADDONS_CPT_TEAM_PT) {
			$mb['email'] = array(
...
if ( !function_exists( 'wizors_investments_trx_addons_editor_load_scripts_admin' ) ) {
	//Handler of the add_action("admin_enqueue_scripts", 'wizors_investments_trx_addons_editor_load_scripts_admin');
...
if ( !function_exists( 'wizors_investments_trx_addons_sc_atts' ) ) {
	//Handler of the add_filter( 'trx_addons_sc_atts', 'wizors_investments_trx_addons_sc_atts', 10, 2);
...
if ( !function_exists( 'wizors_investments_trx_addons_sc_map' ) ) {
	//Handler of the add_filter( 'trx_addons_sc_map', 'wizors_investments_trx_addons_sc_map', 10, 2);
...
if ( !function_exists( 'wizors_investments_trx_addons_sc_output' ) ) {
	//Handler of the add_filter( 'trx_addons_sc_output', 'wizors_investments_trx_addons_sc_output', 10, 4);
...
if ( !function_exists( 'wizors_investments_trx_addons_slider_title' ) ) {
	//Handler of the add_filter( 'trx_addons_filter_slider_title',	'wizors_investments_trx_addons_slider_title', 10, 2 );
...
if ( !function_exists( 'wizors_investments_trx_addons_featured_image' ) ) {
	//Handler of the add_filter( 'trx_addons_filter_featured_image', 'wizors_investments_trx_addons_featured_image', 10, 2);
...
if ( !function_exists( 'wizors_investments_trx_addons_no_image' ) ) {
	//Handler of the add_filter( 'trx_addons_filter_no_image', 'wizors_investments_trx_addons_no_image');
...
if ( !function_exists( 'wizors_investments_trx_addons_get_list_icons' ) ) {
	//Handler of the add_filter( 'trx_addons_filter_get_list_icons', 'wizors_investments_trx_addons_get_list_icons', 10, 2 );
...
if (!function_exists('wizors_investments_trx_addons_query_sort_order')) {
	//Handler of the add_filter('wizors_investments_filter_query_sort_order', 'wizors_investments_trx_addons_query_sort_order', 10, 3);
...
if ( !function_exists( 'wizors_investments_trx_addons_theme_logo' ) ) {
	//Handler of the add_filter( 'trx_addons_filter_theme_logo', 'wizors_investments_trx_addons_theme_logo');
...
if ( !function_exists( 'wizors_investments_trx_addons_post_meta' ) ) {
	//Handler of the add_filter( 'trx_addons_filter_post_meta',	'wizors_investments_trx_addons_post_meta', 10, 2);
...
if ( !function_exists( 'wizors_investments_trx_addons_get_mobile_menu' ) ) {
	//Handler of the add_filter("wizors_investments_filter_get_mobile_menu", 'wizors_investments_trx_addons_get_mobile_menu');
...
if (!function_exists('wizors_investments_trx_addons_action_login')) {
	//Handler of the add_action( 'wizors_investments_action_login',		'wizors_investments_trx_addons_action_login', 10, 2);
...
if (!function_exists('wizors_investments_trx_addons_action_search')) {
	//Handler of the add_action( 'wizors_investments_action_search', 'wizors_investments_trx_addons_action_search', 10, 3);
...
if (!function_exists('wizors_investments_trx_addons_action_breadcrumbs')) {
	//Handler of the add_action( 'wizors_investments_action_breadcrumbs',	'wizors_investments_trx_addons_action_breadcrumbs');
...
if (!function_exists('wizors_investments_trx_addons_action_show_layout')) {
	//Handler of the add_action( 'wizors_investments_action_show_layout', 'wizors_investments_trx_addons_action_show_layout', 10, 1);
...
if ( !function_exists( 'wizors_investments_trx_addons_get_blog_title' ) ) {
	//Handler of the add_filter( 'wizors_investments_filter_get_blog_title', 'wizors_investments_trx_addons_get_blog_title');
...
if (!function_exists('wizors_investments_trx_addons_prepare_css')) {
	//Handler of the add_filter( 'wizors_investments_filter_prepare_css',	'wizors_investments_trx_addons_prepare_css', 10, 2);
...
if (!function_exists('wizors_investments_trx_addons_prepare_js')) {
	//Handler of the add_filter( 'wizors_investments_filter_prepare_js',	'wizors_investments_trx_addons_prepare_js', 10, 2);
...
if (!function_exists('wizors_investments_trx_addons_get_css')) {
	//Handler of the add_filter('wizors_investments_filter_get_css', 'wizors_investments_trx_addons_get_css', 10, 4);
